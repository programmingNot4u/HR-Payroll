...
export default function LeaveRequest() {
      ...
      leaveBalance: {
        ...
        maternity:
          employee.gender === "Female"
            ? Math.max(0, maternityMax - Math.floor(Math.random() * 20))
            : 0,
  ...
  const filteredEmployees = useMemo(() => {
    return employeesWithPolicyBalances.filter((employee) => {
      const matchesId =
        ...
        employee.name.toLowerCase().includes(filters.employeeId.toLowerCase());
  ...
  const isLeaveValid = useMemo(() => {
    ...
    if (selectedEmployeeData && selectedLeaveTypeData) {
      const availableBalance =
        selectedEmployeeData.leaveBalance[leaveType] || 0;
  ...
  const handleEmployeeSearch = () => {
    ...
    const employee = employeesWithPolicyBalances.find(
      (emp) =>
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500">
          Comprehensive leave management system for employees
        </p>
      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-200">
                  ...
                  <p className="text-sm text-gray-500">
                    All leave requests submitted from employee portal
                  </p>
                </div>
                      ...
                      {filteredEmployees.length > 0 ? (
                        filteredEmployees.map((employee) => (
                          <tr key={employee.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-center">
                              <span
                                className={`text-sm font-medium ${getLeaveBalanceColor(
                                  employee.leaveBalance.casual,
                                  parseInt(leavePolicies.casualLeave) || 10
                                )}`}>
                                {employee.leaveBalance.casual}/
                                {parseInt(leavePolicies.casualLeave) || 10}
                              </span>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-center">
                              <span
                                className={`text-sm font-medium ${getLeaveBalanceColor(
                                  ...
                                  parseInt(leavePolicies.sickLeave) || 15
                                )}`}>
                                {employee.leaveBalance.sick}/
                                {parseInt(leavePolicies.sickLeave) || 15}
                              </span>
                              ...
                              {employee.gender === "Female" ? (
                                <span
                                  className={`text-sm font-medium ${getLeaveBalanceColor(
                                    ...
                                    parseInt(leavePolicies.maternityLeave) ||
                                      180
                                  )}`}>
                                  {employee.leaveBalance.maternity}/
                                  {parseInt(leavePolicies.maternityLeave) ||
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-center">
                              <span
                                className={`text-sm font-medium ${getLeaveBalanceColor(
                                  ...
                                  parseInt(leavePolicies.earnedLeave) || 30
                                )}`}>
                                {employee.leaveBalance.earned}/
                                {parseInt(leavePolicies.earnedLeave) || 30}
                              </span>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <p className="text-sm text-gray-500 mb-6">
                  Search by employee ID to view their leave details and patterns
                </p>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900">
                            {trackedEmployee.name}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">Department</p>
                          <p className="font-medium text-gray-900">
                            {trackedEmployee.department}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">Designation</p>
                          <p className="font-medium text-gray-900">
                            {trackedEmployee.designation}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">Level of Work</p>
                          <p className="font-medium text-gray-900">
                            {trackedEmployee.levelOfWork}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-500">Gender</p>
                          <p className="font-medium text-gray-900">
                            {trackedEmployee.gender}
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="p-6">
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                          <div className="text-center">
                            ...
                            <p
                              className={`text-2xl font-bold ${getLeaveBalanceColor(
                                trackedEmployee.leaveBalance.casual,
                                parseInt(leavePolicies.casualLeave) || 10
                              )}`}>
                              {trackedEmployee.leaveBalance.casual}/
                              {parseInt(leavePolicies.casualLeave) || 10}
                          ...
                          <div className="text-center">
                            ...
                            <p
                              className={`text-2xl font-bold ${getLeaveBalanceColor(
                                trackedEmployee.leaveBalance.sick,
                                parseInt(leavePolicies.sickLeave) || 15
                              )}`}>
                              {trackedEmployee.leaveBalance.sick}/
                              {parseInt(leavePolicies.sickLeave) || 15}
                          ...
                          <div className="text-center">
                            ...
                            <p
                              className={`text-2xl font-bold ${getLeaveBalanceColor(
                                trackedEmployee.leaveBalance.annual,
                                21
                              )}`}>
                          ...
                          <div className="text-center">
                            ...
                            <p
                              className={`text-2xl font-bold ${
                                trackedEmployee.gender === "Female"
                                  ? getLeaveBalanceColor(
                                      trackedEmployee.leaveBalance.maternity,
                                      parseInt(leavePolicies.maternityLeave) ||
                                        180
                                    )
                                  : "text-gray-400"
                          ...
                          <div className="text-center">
                            ...
                            <p
                              className={`text-2xl font-bold ${getLeaveBalanceColor(
                                trackedEmployee.leaveBalance.earned,
                                parseInt(leavePolicies.earnedLeave) || 30
                              )}`}>
                              {trackedEmployee.leaveBalance.earned}/
                              {parseInt(leavePolicies.earnedLeave) || 30}
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                      ...
                      <div className="overflow-x-auto">
                        <table className="min-w-full divide-y divide-gray-200">
                          ...
                          <tbody className="bg-white divide-y divide-gray-200">
                            {getEmployeeLeaveRequests(trackedEmployee.id)
                              .length > 0 ? (
                              getEmployeeLeaveRequests(trackedEmployee.id).map(
                                (request) => (
                                  <tr
                                    key={request.id}
                ...
                <div>
                  ...
                  <select
                    ...
                    {leaveTypes.map((type) => {
                      ...
                      if (
                        type.id === "maternity" &&
                        selectedEmployeeData?.gender === "Male"
                      ) {
                        return null;
                      }
                      return (
                        <option key={type.id} value={type.id}>
                          ...
                          {type.id === "maternity" &&
                            selectedEmployeeData?.gender === "Female" &&
                            " - Female Only"}
                        </option>
                      );
                    })}
                  ...
                  {selectedLeaveTypeData && (
                    <p className="mt-1 text-sm text-gray-500">
                      ...
                      {selectedLeaveTypeData.id === "maternity" &&
                        selectedEmployeeData?.gender === "Female" &&
                ...
                {selectedEmployee && leaveType && (
                  <div className="bg-blue-50 p-3 rounded-md">
                    <p className="text-sm text-blue-800">
                      ...
                      {getLeaveBalance(selectedEmployee, leaveType)} days
                      {selectedLeaveTypeData &&
                        ` out of ${selectedLeaveTypeData.maxDays} maximum`}
                    </p>
                  </div>
                )}
                  ...
                  <div className="bg-gray-50 p-3 rounded-md">
                    ...
                    {selectedEmployee && leaveType && (
                      <p
                        className={`text-sm ${
                          totalDays >
                          getLeaveBalance(selectedEmployee, leaveType)
                            ? "text-red-600"
                            : "text-green-600"
                        }`}>
                        {totalDays >
                        getLeaveBalance(selectedEmployee, leaveType)
                          ? `⚠️ Insufficient balance (${getLeaveBalance(
                              selectedEmployee,
                              leaveType
                            )} days available)`
