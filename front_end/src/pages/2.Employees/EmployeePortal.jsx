...
export default function EmployeePortal() {
  ...
  useEffect(() => {
    const checkAuthStatus = () => {
      if (authService.isAuthenticated()) {
        ...
        const isImpersonatingFlag =
          localStorage.getItem("isImpersonating") === "true";

        setIsImpersonating(isImpersonatingFlag);

        if (isEmployee && !isImpersonatingFlag) {
          // Employee is logged in directly - skip login form
          setCurrentEmployee(mockEmployee); // You can fetch real employee data here
          setIsLoggedIn(true);
        } else if (isImpersonatingFlag) {
          // HR is impersonating an employee
          setCurrentEmployee(mockEmployee); // You can fetch the impersonated employee data here
          setIsLoggedIn(true);
        }
        // If HR is not impersonating, show login form for employee selection
      }
    };
  ...
  const timesheetData = [
    ...
    },
    {
      ...
      project: "Bug Fixes",
      hours: 6,
      description: "Resolving critical issues",
    },
    {
      date: "2024-01-12",
      project: "HR System Development",
  ...
  const handleLogin = (e) => {
    ...
    if (
      loginCredentials.employeeId === "EMP001" &&
  ...
  // Only show login form if user is not logged in AND is not an employee
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-white to-orange-100 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute -bottom-40 -left-40 w-80 h-80 bg-orange-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"
            style={{ animationDelay: "2s" }}></div>
          <div
            className="absolute top-40 left-1/2 w-80 h-80 bg-orange-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse"
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 border border-white/20">
            <form className="space-y-4 sm:space-y-6" onSubmit={handleLogin}>
              ...
              <button
                ...
                <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                  <svg
                    className="h-5 w-5 text-orange-200 group-hover:text-orange-100 transition-colors"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path
            ...
            <div className="mt-8 p-4 bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl border border-orange-200">
              ...
              <div className="text-sm text-orange-700 space-y-1">
                <p>
                  <span className="font-medium">Employee ID:</span> EMP001
                </p>
                <p>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-gray-600 text-sm sm:text-base md:text-lg truncate">
                  Welcome back,{" "}
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
              {isImpersonating && (
                <button
                  ...
                  className="group relative bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-200 transform hover:scale-105 hover:shadow-lg text-sm sm:text-base w-full sm:w-auto">
                  <span className="absolute left-0 inset-y-0 flex items-center pl-2 sm:pl-3">
                    <svg
                      className="h-4 w-4 sm:h-5 sm:w-5 text-blue-200 group-hover:text-blue-100 transition-colors"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24">
                      <path
                  ...
                  <span className="pl-6 sm:pl-8">Return to HR</span>
                </button>
              )}
              <button
                ...
                <span className="absolute left-0 inset-y-0 flex items-center pl-2 sm:pl-3">
                  <svg
                    className="h-4 w-4 sm:h-5 sm:w-5 text-red-200 group-hover:text-red-100 transition-colors"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path
                ...
                <span className="pl-6 sm:pl-8">Logout</span>
              </button>
            </div>
          </div>
        </div>
          ...
          <nav className="flex space-x-1 sm:space-x-2 overflow-x-auto scrollbar-hide">
            {[
              ...
              <button
                ...
                <svg
                  className={`w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2 transition-colors ${
                    activeTab === tab.id
                      ? "text-white"
                ...
                <div className="group bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-4 sm:p-6 border border-white/20 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                      ...
                      <p className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 group-hover:text-green-600 transition-colors">
                        95%
                      </p>
          ...
          {activeTab === "settings" && (
            <div className="space-y-6">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 border border-white/20">
                <div className="flex items-center mb-6">
                  <div className="h-10 w-10 bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg flex items-center justify-center mr-3">
                    <svg
                      className="h-6 w-6 text-white"
                      fill="none"
                      stroke="currentColor"
                ...
                <form onSubmit={handlePasswordSubmit} className="space-y-4">
                  ...
                  <div className="flex justify-end">
                    <button
                      type="submit"
                      disabled={isChangingPassword}
                      className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-lg font-semibold shadow-lg hover:from-orange-600 hover:to-orange-700 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
                      {isChangingPassword && (
                        <svg
